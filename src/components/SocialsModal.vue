<template>
  <div class="w-full h-full bg-gray-950 bg-opacity-80 flex items-center justify-center absolute top-0 left-0">
    <div class="bg-gray-100 w-full p-4 rounded-xl md:w-1/2 lg:w-1/3">
      <div
      ...
      >
        ...
        <div class="bg-gray-300 hover:bg-gray-500 cursor-pointer hover:text-gray-300 font-sans text-gray-500 w-8 h-8 flex items-center justify-center rounded-full" @click="close">
          x
        </div>
      </div>
      ...
      <div class="my-4">
        ...
        <div class="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
          ...
          <input class="w-full outline-none bg-transparent" type="text" placeholder="link" value="https://quotetier.example.dontclick/?query=link">
